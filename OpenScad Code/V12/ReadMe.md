...
These assets can be created from the Openscad pipeline when operated from both [MT-Customizer.scad](#customizer-scad) and [MT-Master.scad](#master-scad) through a terminal script.

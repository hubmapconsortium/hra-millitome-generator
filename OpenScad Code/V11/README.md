...
[This webpage contains information about how to set up command line access of Openscad on Windows and MacOS](https://en.wikibooks.org/wiki/OpenSCAD_User_Manual/Using_OpenSCAD_in_a_command_line_environment).

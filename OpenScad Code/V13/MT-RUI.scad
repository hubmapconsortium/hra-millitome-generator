// Millitome RUI V13.001
//  developer: Peter Kienle, CNS

// V13  2023-1-12

// TODO
//  align position of cutting matrix to organ, according to data in json file
//  or the other way around
//  in RUI position of block stays when rotated, how in cutting matrix?
//  --> replicate functionaly of RUI (single block, location, size, roation), use customizer
...
//  - organID       0=kidney_l, 1=kidney_r, 2=spleen, 3=pancreas, 4=banana, 5=vb_pancreas, 6=ovary_l
...
organID         = 6;    // index for list lookup

organ_scaleID   = 1;    // 0=large,1=medium,2=small                    
asset_typeID    = 1;    // 6=organblocks, 7=boxblocks, 0=organ
